...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'projects_task', 'status',
                      self.gf('django.db.models.fields.CharField')(default='open', max_length=7),
                      keep_default=False)


        # Changing field 'Task.project'
        db.alter_column(u'projects_task', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['projects.Project']))

        # Changing field 'Task.assigned'
        db.alter_column(u'projects_task', 'assigned_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['profiles.TeamMember']))

    def backwards(self, orm):
        # Deleting field 'Task.status'
        db.delete_column(u'projects_task', 'status')


        # Changing field 'Task.project'
        db.alter_column(u'projects_task', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['projects.Project']))

        # Changing field 'Task.assigned'
        db.alter_column(u'projects_task', 'assigned_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['profiles.TeamMember']))
