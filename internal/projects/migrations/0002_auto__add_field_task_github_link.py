...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.github_link'
        db.add_column(u'projects_task', 'github_link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.github_link'
        db.delete_column(u'projects_task', 'github_link')
    ...
    models = {
        ...
        u'projects.task': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'github_link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
