...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Project', fields ['name', 'github_repo_link']
        db.create_unique(u'projects_project', ['name', 'github_repo_link'])


    def backwards(self, orm):
        # Removing unique constraint on 'Project', fields ['name', 'github_repo_link']
        db.delete_unique(u'projects_project', ['name', 'github_repo_link'])
