...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.github_repo_link'
        db.add_column(u'projects_project', 'github_repo_link',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'projects_project', 'github_milestone_link',
                      self.gf('django.db.models.fields.URLField')(blank=True, max_length=200, null=True, db_index=True),
                      keep_default=False)

        # Deleting field 'Project.github_repo_link'
        db.delete_column(u'projects_project', 'github_repo_link')
