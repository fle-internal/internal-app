...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'projects_task', (
            ...
            ('assigned', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tasks_assigned', to=orm['profiles.TeamMember'])),
        ...
        db.create_table(u'projects_project', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='projects_owned', to=orm['profiles.TeamMember'])),
            ('start_date', self.gf('django.db.models.fields.DateField')(max_length=10)),
            ('deadline', self.gf('django.db.models.fields.DateField')(max_length=10)),
        ...
        db.create_table(u'projects_role', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='roles', to=orm['profiles.TeamMember'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project'])),
            ('role_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
    ...
    models = {
        ...
        u'projects.task': {
            ...
            'assigned': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tasks_assigned'", 'to': u"orm['profiles.TeamMember']"}),
            'deadline': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tasks'", 'to': u"orm['projects.Project']"})
        }
    }
