...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Role', fields ['profile', 'project']
        db.create_unique(u'projects_role', ['profile_id', 'project_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Role', fields ['profile', 'project']
        db.delete_unique(u'projects_role', ['profile_id', 'project_id'])
    ...
    models = {
        ...
        u'projects.role': {
            'Meta': {'unique_together': "(('profile', 'project'),)", 'object_name': 'Role'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
