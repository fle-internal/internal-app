...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Task', fields ['github_link']
        db.create_index(u'projects_task', ['github_link'])


    def backwards(self, orm):
        # Removing index on 'Task', fields ['github_link']
        db.delete_index(u'projects_task', ['github_link'])
